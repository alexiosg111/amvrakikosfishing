...
async function main() {
  ...
  const reviewsData = [
    ...
    },
    {
      ...
      userId: 'Alicia Rivera',
      rating: 3,
      comment: 'Unique night experience and plenty of bites. A little windy but still fun.',
      isVerified: true,
    },
    {
      tripId: tripMap.get('Private Charter Experience') || '',
      userId: 'The Johnson Family',
      rating: 5,
  ...
  const galleryImagesData = [
    ...
    },
    {
      ...
      description: 'Fresh catch shimmering in the evening light',
    ...
    {
      title: 'Deck Ready for Adventure',
      description: 'Spacious deck set up for your comfort',
    ...
    {
      title: 'Morning Mist',
      description: 'Sunrise over calm waters',
